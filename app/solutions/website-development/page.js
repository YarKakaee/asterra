					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
						...
						>
							...
							>
								...
								that not only look amazing but drive real
								business results. From design to deployment, we
								handle everything.
							</motion.p>
							...
							<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
								...
								>
									...
									<p className="text-gray-700 text-sm">
										Responsive designs that look perfect on
										every device, from mobile to desktop.
									</p>
								</motion.div>
								...
								>
									...
									<p className="text-gray-700 text-sm">
										Optimized for speed with clean code and
								...
								>
									...
									<p className="text-gray-700 text-sm">
										Built with SEO best practices to help
										your website rank higher in search
										results.
									</p>
								</motion.div>
								...
								>
									...
									<p className="text-gray-700 text-sm">
										Enterprise-grade security with regular
										updates and monitoring for peace of
										mind.
									</p>
								</motion.div>
								...
								>
									...
									<p className="text-gray-700 text-sm">
										Intuitive navigation and user-friendly
										designs that keep visitors engaged.
									</p>
								</motion.div>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
						...
						>
							...
							<motion.p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
								Here&apos;s a behind-the-scenes look at how we
								create stunning, high-performance websites —
						...
						<div className="grid lg:grid-cols-2 gap-12 items-start">
							<div>
								...
								<p className="text-white/80 mb-6 text-lg">
									...
									methodologies to create websites that are
								...
								<div className="space-y-6">
									<div className="flex items-start">
										...
										<div>
											...
											<p className="text-white/70 text-sm">
												We start with detailed
												wireframes and interactive
												prototypes to visualize your
									...
									<div className="flex items-start">
										...
										<div>
											...
											<p className="text-white/70 text-sm">
												We create a comprehensive design
												system with consistent colors,
									...
									<div className="flex items-start">
										...
										<div>
											...
											<p className="text-white/70 text-sm">
												Clean, semantic code that works
												perfectly across all devices and
												screen sizes.
											</p>
										</div>
									</div>
									<div className="flex items-start">
										...
										<div>
											...
											<p className="text-white/70 text-sm">
												We optimize for speed, SEO, and
												accessibility to ensure maximum
												impact.
											</p>
										</div>
									</div>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						>
							...
							<p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
								Let&apos;s create a website that not only looks
								amazing but drives real business results. Get
