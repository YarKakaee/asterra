...
const BarbershopsSalonsPage = () => {
	...
	return (
		<>
			...
			<main>
				{/* Hero Section with Barber Image */}
				<section
					ref={heroRef}
				...
				>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
						...
						>
							...
							>
								AI receptionist that books appointments, handles
								cancellations, and manages your schedule — all
								while you focus on what you do best: making
								...
								<div className="grid md:grid-cols-3 gap-8">
									...
									>
										...
										<p className="text-gray-700 text-sm">
											Every missed call is a potential
											client walking away. You can&apos;t
											answer the phone while cutting hair
											or doing treatments.
										</p>
									</div>
									...
									>
										...
										<p className="text-gray-700 text-sm">
											Empty chairs mean lost income. You
											need automated reminders and easy
											rescheduling to keep your schedule
											full.
										</p>
									</div>
									...
									>
										...
										<p className="text-gray-700 text-sm">
											Spending hours on admin work instead
											of perfecting your craft. You need
											systems that work while you work.
										</p>
									</div>
								</div>
							</motion.div>
									...
									<div className="grid lg:grid-cols-2 gap-12 items-center">
										<div>
											<div className="flex items-center mb-6">
												<div className="w-12 h-12 bg-gradient-to-br from-[#FF5633] to-orange-600 rounded-xl flex items-center justify-center text-white font-bold text-lg mr-4">
													AI
												</div>
											...
											<p className="text-gray-700 mb-6 text-lg">
												...
												every call, books appointments,
												handles cancellations, and even
												upselling—all in your brand
												voice. Never miss another
												booking opportunity.
											</p>
									...
									<div className="grid md:grid-cols-2 gap-8">
										...
										>
											...
											<p className="text-gray-700 text-sm">
												...
												birthday reminders, and loyalty
												programs to keep clients coming
												back.
											</p>
										</motion.div>
									</div>
									...
									<div className="grid md:grid-cols-3 gap-8">
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												...
												booking system and phone number.
												No disruption to your current
												workflow.
											</p>
										</div>
										<div className="text-center">
										...
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												...
												love—creating amazing looks for
												your clients.
											</p>
										</div>
									</div>
							...
							>
								...
								>
									<h2 className="text-3xl font-bold text-gray-900 mb-4">
										Ready to Never Miss Another Booking?
									</h2>
									<p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
										Join hundreds of barbershops and salons
										who&apos;ve increased their bookings and
										reduced their admin workload with our AI
										receptionist.
									</p>
...
export default BarbershopsSalonsPage;
