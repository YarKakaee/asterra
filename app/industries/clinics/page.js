				...
				>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
						...
						>
							...
							>
								AI receptionist that schedules appointments,
								handles patient inquiries, and manages your
								calendar—so you can focus on what matters most:
								patient care.
							</motion.p>
						...
						>
							...
							>
								<h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
									What&apos;s Draining Your Practice&apos;s
									Potential
								</h2>
								...
								<div className="grid md:grid-cols-3 gap-8">
									...
									>
										...
										<p className="text-gray-700 text-sm">
											...
											they go elsewhere. You can&apos;t
											answer the phone while treating
											patients.
										</p>
									</div>
							...
							>
								<h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
									The Healthcare Revolution Starts Here
								</h2>
									...
									<div className="grid lg:grid-cols-2 gap-12 items-center">
										<div>
											...
											<p className="text-gray-700 mb-6 text-lg">
												...
												patient call. It understands
												medical terminology and handles
												your practice&apos;s unique
												needs.
											</p>
									...
									<div className="grid md:grid-cols-2 gap-8">
										...
										>
											...
											<p className="text-gray-700 text-sm">
												...
												with online booking, patient
												portals, and telemedicine
												integration that build trust and
												convenience.
											</p>
										</motion.div>
										...
										>
											...
											<p className="text-gray-700 text-sm">
												...
												health check-ins that keep
												patients engaged and coming
												back.
											</p>
										</motion.div>
									</div>
									...
									<div className="grid md:grid-cols-3 gap-8">
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												...
												EMR, scheduling system, and
												phone lines. Zero disruption to
										...
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												Our AI learns your specialties,
												procedures, and patient care
												protocols. It becomes your
												perfect medical assistant.
											</p>
										</div>
										<div className="text-center">
											<div className="w-16 h-16 bg-[#FF5633] rounded-full flex items-center justify-center mx-auto mb-4">
											...
											<p className="text-gray-700 text-sm">
												Watch your patient satisfaction
												soar and your schedule optimize
												while you focus on what you do
												best—healing and caring.
											</p>
										</div>
									</div>
								</div>
							...
							>
								...
								>
									...
									<p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
										Join the healthcare providers already
										using our AI to enhance patient care and
