				...
				>
					...
					<div className="absolute inset-0 top-16">
						<Image
							...
							alt="Small business retail store interior"
							fill
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
						...
						>
							...
							>
								AI receptionist that handles customer inquiries,
								books appointments, and manages your schedule—so
								you can focus on what you do best: growing your
								business.
							</motion.p>
				...
				>
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						>
								...
								<div className="grid md:grid-cols-3 gap-8">
									...
									>
										...
										<p className="text-gray-700 text-sm">
											...
											they go to your competition. You
									...
									>
										...
										<p className="text-gray-700 text-sm">
											...
											and customer communications manually
											steals time from what you do
											best—serving your customers and
							...
							>
								<h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
									The Small Business Revolution Starts Here
								</h2>
									...
									<div className="grid lg:grid-cols-2 gap-12 items-center">
										<div>
											...
											<p className="text-gray-700 mb-6 text-lg">
												...
												your business and handles your
												unique needs.
											</p>
									...
									<div className="grid md:grid-cols-2 gap-8">
										...
										>
											...
											<p className="text-gray-700 text-sm">
												...
												reviews, and lead capture forms
							...
							>
								<h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
									From Chaos to Growth in 3 Steps
								</h2>
									...
									<div className="grid md:grid-cols-3 gap-8">
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												...
												systems, phone lines, and
												business tools. Zero disruption
										...
										<div className="text-center">
											...
											<p className="text-gray-700 text-sm">
												Watch your customer satisfaction
												soar and your business grow
							...
							>
								...
								>
									...
									<p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
										Join the small business owners already
										using our AI to streamline their
...
export default SmallBusinessesPage;
